...
@Component({
  selector: 'app-ratingp',
  templateUrl: './ratingp.component.html',
  styleUrls: ['./ratingp.component.css']
})
export class RatingpComponent implements OnInit {
...
loadData(id) {
  this.http.get("https://whispering-thicket-97767.herokuapp.com/rating/preview/" + id).subscribe(data => {
